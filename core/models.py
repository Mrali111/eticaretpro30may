...
class CustomUser(AbstractUser):
    ...
    # phone_number = models.CharField(max_length=20, blank=True, null=True)  #bunu da elave ede bilersen, vacib deyil
...
class Product(models.Model):
    ...
    cover_image = models.ImageField(upload_to="product_imgs/")
...
class SiteSettings(models.Model):
    ...
    story_image1 = models.ImageField(upload_to="site_imgs/")
    story_image2 = models.ImageField(upload_to="site_imgs/")

    opening_hours = models.TextField(blank=True, null=True)
    opening_image = models.ImageField(upload_to="site_imgs/")
